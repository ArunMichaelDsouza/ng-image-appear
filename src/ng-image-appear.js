...
var ngImageAppear = angular.module('ngImageAppear', []).directive('ngImageAppear', function() {
    return {
        ...
        link: function(scope, element, attrs) {
            ...
            var transitionDurationAttr, 
                showLoaderAttr,
                loaderBgColorAttr,
                loaderImgAttr;

            // Fetching element attributes
            transitionDurationAttr = attrs.transitionDuration; // Get transition duration
            ...
            if(showLoaderAttr) {
                ...
                loader = document.getElementsByClassName('ng-image-appear-img-loader'); // Get loader element
            }
