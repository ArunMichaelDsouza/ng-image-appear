    ...
    return {
        ...
        link: function(scope, element, attrs) {
            ...
            var transitionDurationAttr = attrs.transitionDuration, // Set transition duration
                ...
                placeholderImgAttr = attrs.placeholderImg, // Check if default placeholder image is to be shown
                ...
                animationTypeAttr = attrs.animationType, // Set animation type
            ...
            transitionDurationAttr = !transitionDurationAttr ? .7+'s' : transitionDurationAttr; // Set transition duration, default - 700ms
            bgColorAttr = !bgColorAttr ? defaultBackgroundColor : bgColorAttr, // Set default bg color for loader wrapper
            animationDurationAttr = !animationDurationAttr ? .7+'s' : animationDurationAttr; // Set transition duration, default - 700ms
            ...
            function renderLoader() {
                ...
                if(loaderImgAttr) {
                    ...
                    // Else throw warning in console
                        ...
                        console.warn('The custom loader image should have a gif extension. Read full documentation here - https://github.com/ArunMichaelDsouza/ng-image-appear');
                    }
                }
                else {
                    showLoader();
            ...
            element.bind('load', function() {
                ...
                $timeout(function() {
                    element.css({
                        ...
                        'transition': ' all '+ transitionDurationAttr +' ease-in-out ', // Set element transition
